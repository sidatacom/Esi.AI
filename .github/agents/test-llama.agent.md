---
name: "Test Llama"
description: "Runs a narrow end-to-end chat smoke test against the loaded LLamaSharp/CUDA/Vulkan model in Esi.AI Studio."
model: "tinyllama-1.1b-chat-v1.0.Q2_K.gguf (esi-ai-studio)"
...
Test the currently loaded LLamaSharp model through the Esi.AI Studio chat path.
