---
name: "Test vLLM"
description: "Runs a narrow end-to-end chat smoke test against a loaded vLLM model in Esi.AI Studio."
...
Test the currently loaded vLLM model through the Esi.AI Studio OpenAI-compatible chat path.
