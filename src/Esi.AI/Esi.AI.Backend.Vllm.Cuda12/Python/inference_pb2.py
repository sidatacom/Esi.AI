"""Runtime protobuf types for the local Esi.AI vLLM inference bridge."""
...
_field(load_request, "quantization", 10, 9)
_field(load_request, "dtype", 11, 9)
_field(load_request, "kv_cache_dtype", 12, 9)
_field(load_request, "speculative_config_json", 13, 9)
_field(load_request, "max_num_seqs", 14, 13)
_field(load_request, "max_num_batched_tokens", 15, 13)
_field(load_request, "enable_prefix_caching", 16, 8)
_field(load_request, "enable_xpu_graph", 17, 8)
_field(load_request, "enable_bf16_mtp_draft", 18, 8)
...
_field(chat_message, "tool_calls_json", 3, 9)
_field(chat_message, "tool_call_id", 4, 9)

tool_definition = file_descriptor.message_type.add(name="ToolDefinition")
_field(tool_definition, "type", 1, 9)
_field(tool_definition, "name", 2, 9)
_field(tool_definition, "description", 3, 9)
_field(tool_definition, "parameters_json", 4, 9)
...
_field(generate_request, "top_k", 7, 5)
_field(generate_request, "min_p", 8, 2)
_field(generate_request, "repetition_penalty", 9, 2)
_field(generate_request, "seed", 10, 5)
_field(generate_request, "stop_sequences", 11, 9, 3)
_field(generate_request, "tools", 12, 11, 3, ".esi.ai.inference.ToolDefinition")
_field(generate_request, "tool_choice_json", 13, 9)
...
_field(generate_response, "tool_calls_json", 7, 9)
...
ToolDefinition = message_factory.GetMessageClass(DESCRIPTOR.message_types_by_name["ToolDefinition"])
