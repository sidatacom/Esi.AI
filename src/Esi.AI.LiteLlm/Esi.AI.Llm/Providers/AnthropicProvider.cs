...
/// <summary>
/// Anthropic-kompatibler Chat-Completion-Provider.
/// Kommuniziert mit der Anthropic API (oder jedem anderen Anthropic-kompatiblen Endpoint).
/// </summary>
public class AnthropicProvider : IChatCompletionProvider
{
    ...
    /// <summary>
    /// Initialisiert einen neuen Anthropic-Provider.
    /// </summary>
    /// <param name="apiKey">API-Key für die Anthropic API.</param>
    /// <param name="endpoint">API-Endpoint (z.B. "https://api.anthropic.com").</param>
    public AnthropicProvider(string apiKey, string endpoint = "https://api.anthropic.com")
    {
        _apiKey = apiKey;
        _endpoint = endpoint;
    ...
    /// <summary>
    /// Nicht-streaming Chat Completion über den Anthropic Provider.
    /// </summary>
